...
var MongoURI = process.env.NODE_ENV === 'production' ? process.env.MONGODB_URI : 'mongodb://localhost'
...
function riderRequestHandler(request, response) {
    response.sendFile(__dirname + '/public/rider.html');
}
...
app.get('/rider', riderRequestHandler);
